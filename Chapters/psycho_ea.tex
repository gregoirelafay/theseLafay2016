...
\item catégories de concepts:  Regroupe des objets abstraits qui ne sont pas ancrés dans une réalité physique (art, stratégie, sentiments).
\end{itemize}
...
\begin{figure}[t]
        \myfloatalign
        \subfloat[]
        {\includegraphics[width=.5\linewidth]{gfx/ch_3/tonesim_slow-eps-converted-to}}
        \subfloat[]
        {\includegraphics[width=.5\linewidth]{gfx/ch_3/tonesim_fast-eps-converted-to}}
...
\begin{figure}[t]
        \myfloatalign
        \subfloat[]
        {\includegraphics[width=.5\linewidth]{gfx/ch_3/gallop_2flux-eps-converted-to}}
        \subfloat[]
        {\includegraphics[width=.5\linewidth]{gfx/ch_3/gallop_1flux-eps-converted-to}}
...
\begin{figure}[t]
        \myfloatalign
        \includegraphics[width=.5\linewidth]{gfx/ch_3/harmo-eps-converted-to}
...
\begin{figure}[t]
        \myfloatalign
        \subfloat[]
        {\includegraphics[width=.5\linewidth]{gfx/ch_3/opn1-eps-converted-to}}
        \subfloat[]
        {\includegraphics[width=.5\linewidth]{gfx/ch_3/opn2-eps-converted-to}}
...
\begin{figure}[t]
        \myfloatalign
        \subfloat[]
        {\includegraphics[width=.5\linewidth]{gfx/ch_3/seqsim1-eps-converted-to}}
        \subfloat[]
        {\includegraphics[width=.5\linewidth]{gfx/ch_3/seqsim2-eps-converted-to}}
