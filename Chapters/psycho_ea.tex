...
Avant d'aller plus loin dans la présentation de nos recherches, ils nous est indispensable ici de dresser \jlc{il nous semble indispensable de dresser ici} un état des lieux des connaissances liées à la perception des sons.
...
SSSSSSSSSSSSSSSSSSSSS\section{Analyse de scènes acoustiques}
\label{sec:ASA}
