...
\begin{figure}[t]
        \myfloatalign
        \subfloat[]
        {\includegraphics[width=.8\linewidth]{gfx/ch_5/xp1_class_1}\label{fig:soundsourcea}} \par
        \subfloat[]
...
\gl{TODO: ATTENTION, correction de bonferroni à remettre}
...
\end{tabular}
\vspace{0.5mm}
\caption{\label{tab:association}\gl{TODO}}
\end{table}
...
\begin{figure}[t]
       ...
       \caption[TODO]{TODO}\label{fig:countLabel}
\end{figure}
