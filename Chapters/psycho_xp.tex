...
\begin{itemize}
\item $L$, $L(T)$ et : on observe des différences significatives uniquement en comparant des groupes relatifs aux i-scènes à des groupes relatifs aux ni-scènes.  Les effets significatives  rendent ainsi uniquement compte des différences entre les i- et ni-scènes;
\item $L(E)$: deux différences significatives sont relevées entre des groupes relatifs aux ni-scènes, à savoir $3_{P(3)}$ \vs~$4_{P(3)}$ et $4_{P(5)}$ \vs~$6_{P(5)}$.
\end{itemize}
