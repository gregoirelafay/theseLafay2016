...
\begin{figure}[t]
       ...
       \caption{Etapes du processus de simulation pour l'analyse sensorielle}\label{fig:etapeSimu}
\end{figure}
...
% fait reporté dans un grand nombre d'études 
...
\subsection[Descripteurs sémantiques]{Étude comparative entre les descripteurs sémantiques}
...
% analyse des caractéristiques des classes trafics \\
% reprendre les conclusions de \citep{lavandier2006contribution} et \citep{ricciardi2015sound}
...
\subsection[Espaces de représentation induits par les descripteurs sémantiques]{Étude des espaces de représentation induits par les descripteurs sémantiques}
...
%  Rajouter $D_b$ + comparaison par pair des descripteurs de marqueurs \\
...
% "Mais nous observons également que le type de descripteurs à utiliser, pour une même source, varie en fonction de la nature de l'environnement." : développer sur le contexte environnemental pour l'agrément, reprendre l'exemple de \emph{foule} \\
% Reprendre la conclusion de l'article et Proposer un modèle perceptif sur la base du modèle prédictif\\
% l'utilisation de trafic reprendre les conclusions de \citep{lavandier2006contribution}\\
% les résultats (2 modes d'obs) concordent avec les observations faites pas \citep{ricciardi2015sound}.\\
...
% "leurs descripteurs structurels" : chiffre. 
...
% "décrits que par les qualités perçues": citation de résultats similaires
...
% HCA sur $S$, et F-mesure des groupes sur ceux établis par la catégorisation
