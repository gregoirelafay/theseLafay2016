...
\gl{Aucun sujet n'a rapporté de problèmes majeurs concernant l'interface de simulation.}
...
\gl{Validation du protocole et des scènes simulées+ go sur la grounded cognition, et the END.}
