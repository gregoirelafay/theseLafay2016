...
Concernant l'analyse \emph{post hoc}, \gl{nous observons si} les systèmes présentent des différences significatives avec la baseline. Pour un $EBR$ de $-6dB$, 4 groupes émergent:
