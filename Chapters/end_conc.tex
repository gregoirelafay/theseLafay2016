...
\gl{Ces observations ont été rendues possibles grâce à l'utilisation de corpus de scènes simulées. La simulation nous permettant de contrôler les caractéristiques structurelles des scènes, il nous est possible de finement apprécier l’effet de leurs variations respectives sur les performances des algorithmes.}

\gl{Sans simulation, de telles observations seraient difficiles à déduire, l’expérimentateur ne possédant plus, en sortie, qu’un résultat brut, global, dissocié de l'état structurel des scènes sonores considérées.}
...
\gl{L'interrogation de systèmes complexes, que sont les processus computationnels utilisés dans le cadre de l’écoute artificielle, par la simulation de données contrôlées, n’est pas un fait marginal, mais bien un exemple de ce que nous pensons être une phase de maturation ubiquitaire en apprentissage artificiel.} 

\gl{De fait, dans beaucoup de domaines d'application de l'intelligence artificielle, la question est posée de la validité et de la robustesse des systèmes chargés d'effectuer des tâches, ou de prendre des décisions susceptibles d'interférer dans nos vies \citep{o2016weapons}.}

\gl{Contrairement aux systèmes experts \citep{Leondes2002xxiii}, dont l'algorithmie peut être étudiée pour prédire leurs comportements, les systèmes actuels, notamment les réseaux profonds, sont d’une complexité telle que l'approche analytique n'est pas privilégiée par la communauté. L’approche consiste alors à analyser la réponse de ces systèmes complexes à des stimuli bien particuliers dont on contrôle à priori mieux les propriétés. Pour exemple, on citera les travaux novateurs de Ian Goodfellow \citep{goodfellow2014explaining} sur l'amélioration de la robustesse des réseaux neuronaux profonds, en analyse d'image, par l'utilisation d’exemples adversaires, des exemples d'apprentissage peu, mais judicieusement modifiés. On peut également citer les travaux de Nguyen et ses collègues \citep{nguyen2015deep} montrant comment l'utilisation d'images totalement synthétiques, optimisant la réponse du système de détection, permet de forcer le système interrogé.}

\gl{Toutes ces études se basent sur le postulat que, devant la complexité de l'objet d'étude, il est possible, par la génération de données choisies, d'interroger cette complexité de manière pertinente. Une telle utilisation dans le domaine de l’apprentissage automatique de paradigmes expérimentaux courants en psychologie expérimentale et en neuroscience est exemplifié par l’utilisation dans la communauté du terme « artificial neuroscience ». Ce rapprochement au niveau méthodologique entre analyse sensorielle et apprentissage automatique est en bonne résonance avec les thèses défendues, à notre échelle, dans cette thèse, montrant son adéquation avec des questionnements majeurs de la communauté scientifique.}
